...
const foodTypes = [
    ...
    new FoodType("What the fuck",
        [Class.sexagon],
        ["scale", 8], 25
    ),
    new FoodType("Rainbow Food",
        [Class.rainbowSquare, Class.rainbowTriangle, Class.rainbowPentagon, Class.rainbowBetaPentagon, Class.rainbowAlphaPentagon, Class.rainbowSexagon],
        ["scale", 9], 10
    ),
